        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            if (!textField1.getText().isEmpty()){
                if (idx != -1) {
                    ...
                    refresh();
                    JOptionPane.showMessageDialog(this, "Dokter Berhasil Ditambahkan!", "Sukses", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(this, "Pilih Poli", "Error", JOptionPane.ERROR_MESSAGE);
                }
            } else {
                JOptionPane.showMessageDialog(this, "Nama Dokter", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
